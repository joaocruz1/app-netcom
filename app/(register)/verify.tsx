...
export default function VerifyCodeScreen() {
  ...
  const handleVerifyCode = () => {
    ...
    if (verificationCode.length !== CODE_LENGTH) {
      Alert.alert('Atenção', 'Por favor, insira o código completo de 6 dígitos.');
      return;
    }
          ...
          <View className="p-6">
            <View className="items-center mb-10">
              ...
              <Text className="text-base text-netcom-text-secondary text-center">
                ...
                <Text className="font-semibold">{email || 'seu e-mail'}</Text>
              </Text>
            </View>
            ...
            <View className="items-center">
              ...
              <TouchableOpacity onPress={() => console.log('Reenviar código para:', email)} className="mt-1">
